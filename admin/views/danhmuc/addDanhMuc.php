...
<body>
  <div class="container">
    <div class="admin-panel" id="create-form">
      <header class="header">
        <h1 id="form-title">Tạo Danh Mục Mới</h1>
        <p>Nhập thông tin chi tiết để tạo danh mục tour du lịch mới</p>
      </header>
      <div class="form-container">
        <form action="<?= BASE_URL_ADMIN . '?act=them-danh-muc' ?>" method="POST">
          <div class="form-group">
            ...
            <input type="text" id="category-name" name="ten_danh_muc"
              placeholder="Nhập tên danh mục (VD: Tour Miền Bắc)" required>
          ...
          <div class="form-group">
            ...
            <textarea id="category-description" name="mo_ta" rows="6"
          ...
          <div class="form-actions">
            ...
            <button type="submit" class="btn-primary">
              ...
              </svg><span id="submit-button-text">Tạo Danh Mục</span>
            </button>
          </div>
        </form>
      </div>
    </div>
    <div class="admin-panel" style="margin-top: 32px; display: none;">
    </div>
  </div>
  <script>
    const defaultConfig = {
      page_title: "Quản Trị Danh Mục Tour Du Lịch",
      add_button_text: "Thêm Danh Mục Mới",
      form_title: "Tạo Danh Mục Mới",
      submit_button_text: "Tạo Danh Mục"
    };
    ...
    async function onConfigChange(config) {
      ...
      if (submitButtonText) {
        submitButtonText.textContent = config.submit_button_text || defaultConfig.submit_button_text;
      }

      // Cập nhật nút "Thêm Danh Mục Mới" nếu nó xuất hiện ở đâu đó khác
      if (addButtonText) {
